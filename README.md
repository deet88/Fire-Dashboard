...
- **Probability of success** — the share of simulated paths that survive to life expectancy, not just the median outcome.
- **International scenario modeling** — 20 countries with pension age, inflation, effective income tax, capital gains treatment, and cost-of-living index, so a relocation or retire-abroad scenario adjusts the model rather than requiring a second spreadsheet.
